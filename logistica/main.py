...
dx_head.image('https://github.com/alebelluco/ernestomeda/blob/main/logistica/logoEM.png?raw=True', width=300)
...
filtered_df = filtered_df[['BOCCETTA' not in text for text in filtered_df['Descrizione doc.']]]
